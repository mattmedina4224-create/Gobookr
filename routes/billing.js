...
module.exports = function (router) {
  router.get('/dashboard/pro/billing', async (ctx) => {
    ...
    const billingDate = isTrial ? prettyDate(subscription.trial_ends_at) : prettyDate(subscription.current_period_end);
